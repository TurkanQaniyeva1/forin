...
function eyecolorss() {
    let eye = [];
    for (let color of users) {
        if (color.eyeColor === "Green") {
            eye.push(color);
        }
    }
    console.log("Yaşil gozlu istifadeciler:", eye);
}
...
function cities() {
    let usCity = [];
    for (let cityus of users) {
        if (cityus.address.city === "San Francisco") {
            usCity.push(cityus);
        }
    }
    console.log("San Francisco da yasayanlar:", usCity);
}
...
function departmens() {
    let userdeppartment = [];
    for (let depart of users) {
        if (depart.company.department === "Engineering") {
            userdeppartment.push(depart);
        }
    }
    console.log("Muhendislik departamenti:", userdeppartment);
}
...
function persongendeer() {
    let genderP = [];
    for (let genders of users) {
        if (genders.gender === "female") {
            genderP.push(genders);
        }
    }
    console.log("qadin cinsi:", genderP);
}

persongendeer();


function persongendeer2() {
    let genderP2 = [];
    for (let genders2 of users) {
        if (genders2.gender === "male") {
            genderP2.push(genders2);
        }
    }
    console.log("kisi cinsi:", genderP2);
}
